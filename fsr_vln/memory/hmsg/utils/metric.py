...
def pixel_accuracy(eval_segm, gt_segm, ignore=[]):
    """sum_i(n_ii) / sum_i(t_i) :param eval_segm: 2D array, predicted
    segmentation :param gt_segm: 2D array, ground truth segmentation :param
    ignore: list of classes to ignore :return: pixel accuracy."""
...
def mean_accuracy(eval_segm, gt_segm, ignore=[]):
    """(1/n_cl) sum_i(n_ii/t_i) :param eval_segm: 2D array, predicted
    segmentation :param gt_segm: 2D array, ground truth segmentation :param
    ignore: list of classes to ignore :return: mean accuracy."""
...
def get_ignore_classes_num(cl, ignore):
    """Returns the number of classes to ignore :param cl: list of classes
    :param ignore: list of classes to ignore :return: number of classes to
    ignore."""
...
def get_pixel_area(segm):
    """Returns the area of the segmentation :param segm: 2D array, segmentation
...
def extract_classes(segm):
    """Extracts the classes from the segmentation :param segm: 2D array,
    segmentation :return: classes and number of classes."""
    cl = np.unique(segm)
    n_cl = len(cl)
...
def union_classes(eval_segm, gt_segm):
    """
    Returns the union of the classes :param eval_segm: 2D array, predicted
    segmentation :param gt_segm: 2D array, ground truth segmentation :return:
...
def extract_masks(segm, cl, n_cl):
    """Extracts the masks of the segmentation :param segm: 2D array,
    segmentation :param cl: list of classes :param n_cl: number of classes
...
def segm_size(segm):
    """Returns the size of the segmentation :param segm: 2D array, segmentation
...
def check_size(eval_segm, gt_segm):
    """Checks the size of the segmentation :param eval_segm: 2D array,
    predicted segmentation :param gt_segm: 2D array, ground truth
    segmentation."""
